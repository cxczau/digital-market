export const companyDescription = {
  ...
  text: [
    ...
    "If you’re not happy with what we have produced for you, we’ll refund your money - that’s how serious we are!*",
    ...
    "We have taken our knowledge and implemented it in a range of businesses in Hospitality, Finance and Retail to name a few.",
  ],
};
